...
import 'pages/more_view/more_menu_view.dart';
...
import 'pages_desktop_specific/more_view/desktop_more_view.dart';
...
class RouteGenerator {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case MoreMenuView.routeName:
        return getRoute(
          shouldUseMaterialRoute: useMaterialPageRoute,
          builder: (_) => const MoreMenuView(),
          settings: RouteSettings(name: settings.name),
        );
      ...
      case DesktopMoreView.routeName:
        return getRoute(
          shouldUseMaterialRoute: useMaterialPageRoute,
          builder: (_) => const DesktopMoreView(),
          settings: RouteSettings(name: settings.name),
        );
